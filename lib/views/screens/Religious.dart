...
class Religiousity extends StatefulWidget {
  const Religiousity({Key? key}) : super(key: key);

  @override
  State<Religiousity> createState() => _ReligiousityState();
}

class _ReligiousityState extends State<Religiousity> {
  int _value = 0;
                  ...
                  Expanded(
                      ...
                      child: Container(
                        child: Column(children: [
                          ...
                          Center(
                            child: Image.asset(
                              "assets/images/png/Religiosity.png",
                            ),
                          ),
                          Padding(
