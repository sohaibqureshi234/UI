...
class Marraige extends StatefulWidget {
  const Marraige({Key? key}) : super(key: key);

  @override
  State<Marraige> createState() => _MarraigeState();
}

class _MarraigeState extends State<Marraige> {
  int _value = 0;
                  ...
                  Expanded(
                      ...
                      child: Container(
                        child: Column(children: [
                          ...
                          Center(
                            child: Image.asset(
                              "assets/images/png/Marraige.png",
                            ),
                          ),
                          Padding(
